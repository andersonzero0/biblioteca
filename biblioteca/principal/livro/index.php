...
<html lang="pt-br">
  ...
  <body>
    ...
    <div class="wrapper">
      <div class="top">
        <h1>Biblioteca WRA - LIVROS</h1>
      </div>

      <nav role='navigation'>
        <ul>
          <li><a class="tablink ativo" href="../index.php">Voltar</a></li>
          <li><a class="tablink" href="?page=novo">Novo Livro</a></li>
          <li><a class="tablink" href="?page=listar">Listar Livro</a></li>
        </ul>
      </nav>
          ...
          switch(@$_REQUEST["page"]){
            ...
            default:
              print "<div class='banner'>
                    ...
                    <span>Área de edição LIVROS.</span>
                    </div>";
          }
        ?>
      </div>
